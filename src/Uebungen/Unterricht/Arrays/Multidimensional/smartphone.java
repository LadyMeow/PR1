...
public class smartphone {
    public static void main(String[] args) {
        ...
        System.out.println(erfolgreichstesSmartphoneQuartal(smartphoneVerkaufszahlen, smartphoneNamen, 42));
        System.out.println(erfolgreichstesSmartphoneQuartal(smartphoneVerkaufszahlen, smartphoneNamen, 1));
    ...
    public static String erfolgreichstesSmartphoneQuartal(int[][] zahlen, String[] namen, int quartalNr) {
        ...
        // nehmen wir an, die erste Zahl ist die Größte Zahl
        // hier muss zumindest eine Zahl im Array sein, sonst Absturz
        int idxGr = 0;
        int biggestNumber = zahlen[0][quartalNr - 1];
        for (int i = 1; i < zahlen.length; i++) { //start bei 1, weil die erste Zahl ja schon in der var biggestNumber ist. Dann brauchen wir das nicht mehr vergleichen
            if (zahlen[i][quartalNr - 1] > biggestNumber) {
                biggestNumber = zahlen[i][quartalNr - 1];
                idxGr = i;
            }
        }
        return namen[idxGr];
